                    ...
                    <form action="{{ route('events.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type_id" id="type_id" class="form-control">
                                <option value="" disabled {{ old('type_id') ? '' : 'selected' }}>Select a type
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="city_id" id="city_id" class="form-control">
                                <option value="" disabled {{ old('city_id') ? '' : 'selected' }}>Select a city
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control"
                                placeholder="Rock Concert" value="{{ old('title') }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ticket_url" id="ticket_url" class="form-control"
                                placeholder="http://kupikartizase.com" value="{{ old('ticket_url') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="image_url" id="image_url" class="form-control"
                                placeholder="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="comment" id="comment" class="form-control"
                                placeholder="This is going to be an amazing rock concert!" value="{{ old('comment') }}"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact" id="contact" class="form-control"
                                placeholder="contact@example.com" value="{{ old('contact') }}" required>
                        </div>

                        <div class="form-group">
                            <label for="location">Location</label>
                            <input type="text" name="location" id="location" class="form-control"
                                placeholder="Madison Square Garden" value="{{ old('location') }}" required>
                        </div>
